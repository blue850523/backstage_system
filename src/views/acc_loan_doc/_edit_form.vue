                    ...
                    <div class="tab-pane fade" id="step1">
                        ...
                        <div class="row gx-0 gy-1">
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="公司出借方"
                                        v-model="
                                            records.document.lessor_company
                                        "
                                        class="form-control"
                                    />
                                </TCFormGroup>
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <TCDropdown
                                        :options="has_transfer_record_option"
                                        v-model="
                                            records.document.has_transfer_record
                                        "
                                        :allowEmpty="false"
                                    />
                                </TCFormGroup>
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <DatePicker
                                        type="date"
                                        v-model="records.document.signed_date"
                                        value-type="format"
                                        placeholder="簽署日期"
                                    />
                                </TCFormGroup>
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="文件有效期"
                                        v-model="records.document.duration"
                                        class="form-control"
                                        v-tc-number
                                        @blur="countDate"
                                    />
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        ...
                                        class="form-control"
                                        disabled
                                        v-model="records.document.expired_day"
                                    />
                                </TCFormGroup>
                            </div>
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        ...
                                        class="form-control"
                                        disabled
                                        v-model="records.document.expired_date"
                                    />
                                </TCFormGroup>
                            </div>
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <TCDropdown
                                        :options="has_transfer_record_option"
                                        v-model="records.document.has_poa"
                                        :allowEmpty="false"
                                    />
                                </TCFormGroup>
                            </div>
                        </div>
                        <div class="subTitle justify-content-between">支票</div>
                        <div class="row gx-0 gy-1">
                            <div class="col-4 row">
                                <TCFormGroup
                                    class="col-4"
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="支票銀行"
                                        v-model="records.document.cheque_bank"
                                        class="form-control"
                                    />
                                </TCFormGroup>
                            </div>
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="支票號碼"
                                        v-model="records.document.cheque_number"
                                        class="form-control"
                                    />
                                </TCFormGroup>
                            </div>
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="文件金額"
                                        v-model="records.document.cheque_amount"
                                        class="form-control"
                                        v-tc-number
                                    />
                                </TCFormGroup>
                            ...
                            <div class="col-4 row">
                                ...
                                <TCFormGroup class="col-6">
                                    <input
                                        placeholder="更新新債權人"
                                        v-model="
                                            records.document.creditor_updated_by
                                        "
                                        class="form-control"
                                    />
                                </TCFormGroup>
...
const API = {
    ...
    createLoanDoc: `/api/account-management/account-document/account-loan-document/create`,
    updateLoanDoc: `/api/account-management/account-document/account-loan-document/update`,
    detailLoanDoc: `/api/account-management/account-document/account-loan-document/detail`,
};
export default {
    name: "edit_form",
    components: {
    ...
    methods: {
        ...
        countDate() {
            ...
            if (duration > 100000) {
                SysUI.alert("新增借貸文件", "文件有效期不得超過100000", true);
                duration = "";
                return;
            }
        ...
        save: async function () {
            ...
            if (this.is_create) {
                ...
                //若PUT借貸文件原檔案就沒圖片 或 原檔案只有一個但換掉後old_file_ids會空 就加一欄空值
                if (
