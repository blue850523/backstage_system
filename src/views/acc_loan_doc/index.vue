    ...
    <div class="accmanage">
        <div class="vc-panel" id="main-panel">
            <div class="vc-panel-heading">
                <span class="vc-panel-title">借貸文件</span>
            ...
            <div class="vc-panel-body">
                ...
                >
                    ...
                    >
                        ...
                        <!-- 追討有效天數 -->
                        <FilterCustomization
                            :label="$t('acc_loan_doc.effective_day')"
                            name="filter_effective_day"
                            id="id_effective_day"
                        >
                            <div class="row d-flex effective_day">
                                <!-- 追討有效天數最小值 -->
                                <input
                                    class="col-5"
                                    v-model="filters.min_effective_day"
                                    v-tc-number
                                />
                                <span class="col-2">
                                    <div style=""></div>
                                ...
                                <input
                                    class="col-5"
                                    v-model="filters.max_effective_day"
                                    v-tc-number
                                />
                            </div>
                        </FilterCustomization>
...
const API = {
    getLoanList: `/api/account-management/account-document/account-loan-document/list`,
    addLoanDoc: `/api/system-management/department/create`,
};
...
export default {
    ...
    methods: {
        ...
        search: async function () {
            ...
            await SysUI.axios("GET", API.getLoanList, this.filters).then(
                (params) => {
