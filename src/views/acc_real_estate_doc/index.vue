    ...
    <div class="accmanage">
        <div class="vc-panel" id="main-panel">
            <div class="vc-panel-heading">
                <span class="vc-panel-title">資產資料(不動產)</span>
                <div class="pull-right">
                    <button class="btn btn-new" @click="create_real_estate()">
                        新增不動產
                    </button>
                </div>
            </div>
            ...
            <div class="vc-panel-body">
                <form id="search-panel" class="vc-panel-body-search watermark-container" @keyup.enter="search()">
                    ...
                    <div class="vc-panel-body-search-row row row-cols-4 gx-0 gy-1">
                        ...
                        <FilterInputField
                            label="資產類型"
                            id="filter_estate_type"
                            name="filter_estate_type"
                            v-model="filters.estate_type"
                        />
                        ...
                        <FilterInputField
                            label="地址關鍵字"
                            id="filter_estate_address"
                            name="filter_estate_address"
                            v-model="filters.estate_address"
                        />

                        <FilterInputField
                            label="公司抵押權"
                            id="filter_mortgage"
                            name="filter_mortgage"
                            v-model="filters.mortgage"
                        />
                    </div>
                                    ...
                                    <tbody>
                                        <tr 
                                            ...
                                            <td class="text-center" :style="operation_col_width()">
                                                <button class="btn btn-p btn-mr4" @click="detail_real_estate(record)">附件</button>
                                                <button class="btn btn-w btn-mr4" @click="edit_real_estate(record)">修改</button>
                                            </td>
                                            <td
                                                v-for="field in filter_fields"
                                                :key="field.key"
...
const API = {
    getRealEstateList: `${process.env.VUE_APP_DEV_LARAVEL}/api/account-management/account-document/real-estate/list`,
};

export default {
    name: "acc_real_estate_doc",
    components: {
        FilterInputField,
        FilterSelectField,
        FilterAccountGroupField,
    ...
    methods: {
        ...
        async search () {
            try {
                let response = await this.axios.get(API.getRealEstateList, { 
                    params: { ...this.filters }
                }).then((res) => res);
        ...
        async detail_real_estate (record) {
            this.$refs.edit_form.detail_record(4);
        },
        async edit_real_estate (record) {
        ...
        async set_permission () {
            ...
            let permission_list_area_map = {
                upper_line: "1_3_3_3_2_2",
                account_no: "1_3_3_3_2_3",
                account_name: "1_3_3_3_2_4",
                estate_area: "1_3_3_3_2_5",
                estate_type: "1_3_3_3_2_6",
                estate_address: "1_3_3_3_2_7",
                owner: "1_3_3_3_2_8",
                stake: "1_3_3_3_2_9",
                register_no: "1_3_3_3_2_10",
                third_party_pledged: "1_3_3_3_2_11",
                mortgage: "1_3_3_3_2_12",
                market_value: "1_3_3_3_2_13",
                valuation_date: "1_3_3_3_2_14",
                net_worth: "1_3_3_3_2_15",
                ownership_confirm_date: "1_3_3_3_2_16",
                remark: "1_3_3_3_2_17",
                staff_name: "1_3_3_3_2_18",
            };
